...
?>
    <body>
        ...
        <div class="footer">
            ...
            <p>Source code can be found on <a class="white" href="https://github.com/Klein-Rop/Gamified-Cyber-Edu" target="_blank">GitHub <img src="/img/github-mark-white.png" style="width: 35px; margin-bottom: -10px; margin-top: 0;"></a></p>
        </div>
